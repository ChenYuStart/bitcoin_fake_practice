...
impl BehaviourBuilder {
    ...
    fn with_connection_keep_alive(mut self, connection_keep_alive: Option<u64>) -> Self {
    ...
    fn with_request_timeout(mut self, request_timeout: Option<u64>) -> Self {
    ...
    fn with_max_request_size(mut self, max_request_size: Option<usize>) -> Self {
    ...
    fn with_max_response_size(mut self, max_response_size: Option<usize>) -> Self {
    ...
    fn build(self) -> Behaviour<GenericCodec> {
